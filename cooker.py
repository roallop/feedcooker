...
class Cooker(object):
    def __init__(
        ...
        self.home_page_url = f"https://github.com/{repository}/releases"
        self.feed_url_without_ext = f"https://github.com/{repository}/releases/download/latest/{urllib.parse.quote(normalized_name)}"
    ...
    def _generate_feed(
        ...
        feed = gen_cls(
            ...
            feed_url=self.feed_url_without_ext + (".json" if gen_cls == JSONFeed else ".xml"),
